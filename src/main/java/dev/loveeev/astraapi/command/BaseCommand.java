package dev.loveeev.astraapi.command;

import dev.loveeev.astraapi.Main;
import dev.loveeev.astraapi.util.Logging;
...
public abstract class BaseCommand implements CommandExecutor {
    ...
    public abstract boolean handle(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args);
}